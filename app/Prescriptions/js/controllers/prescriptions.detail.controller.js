(function () {
    ...
    PrescriptionDetailCtrl.$inject = ['$scope', '$state', '$stateParams', '$rootScope', 'Prescription'];

    function PrescriptionDetailCtrl($scope, $state, $stateParams, $rootScope, Prescription) {
